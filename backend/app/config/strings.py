...
# This file contains all user-facing strings, making them easy to manage,
# update, and eventually localize without changing application logic.

# Contact and Info
CONTACT_INFO = """
👋 Here is our official contact information:
...
⏰ **Support Hours:**
Monday – Saturday: 11:00 AM – 8:00 PM IST

📲 **Connect with us on Social Media:**
• Instagram: https://www.instagram.com/FeeloriOfficial/
• Facebook: https://www.facebook.com/FeeloriOfficial/
• YouTube: https://www.youtube.com/@FeeloriOfficial/
• X (Twitter): https://twitter.com/FeeloriOfficial/
• Pinterest: https://www.pinterest.com/FeeloriOfficial/
...
➡️ https://g.page/r/CbA6KqXz4_UpEBM/review
...
🚚 **FeelOri Shipping Policy**

{city_info}Here are our delivery timelines for all of India:
📍 **Metro & Tier-1 Cities:** 3-5 business days
📍 **Remote & Rural Areas:** 5-7 business days

📦 **Shipping Costs**
🎉 **Free Shipping** on all orders above ₹999!
🛒 For orders below ₹999, charges are calculated at checkout.

🛡️ **Secure & Tracked**
All orders are securely packed and shipped with premium couriers like **Blue Dart, Delhivery, and India Post**. You'll receive a tracking link via email once your order is on its way!

For our full policy, please visit:
https://feelori.com/policies/shipping-policy
"""

SUPPORT_COMPLAINT_RESPONSE = """
...
# Conversational
THANK_YOU_RESPONSE = "You're very welcome! Happy to help anytime! ✨"
ERROR_GENERAL = "I apologize, but I'm experiencing technical difficulties."
ERROR_AI_CONNECTION = "I'm sorry, I'm having trouble connecting to my knowledge base. Could you please rephrase your question?"
ERROR_AI_GENERAL = "I apologize, but I'm having some technical difficulties. How can I help with our products today?"

# Packing Dashboard
PACKING_DEPT_REDIRECT = "All packing operations are now handled on the dashboard. Please use the dashboard link to manage orders."