...
from app.routes import auth, admin, webhooks, public, dashboard, packing, triage, conversations, broadcasts, knowledge_base
...
app.include_router(knowledge_base.router, prefix=f"/api/{settings.api_version}")
